...
Do not claim broad Canada coverage yet.

The next unlock is live catalog trust:

- Phase 1 code is pushed.
- The live Supabase migration still needs verification.
- Customer search and watch creation must prove they work against the live catalog.
...
3. After the live catalog is no longer red, use `post-migration-launch-pack.md`.

Hold until live catalog is safe:
