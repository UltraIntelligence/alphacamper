...
async def sync_bc_parks_directory(
    session: Session,
    *,
    ...
    provider = get_or_create_provider(
        session,
        name="BC Parks Reservation Service",
        kind=ProviderKind.PROVINCIAL,
        base_url="https://camping.bcparks.ca",
        country="CA",
        notes="BC Parks public reservation metadata and availability via CAMIS booking site",
    )
    ...
    try:
        ...
        for row in rows:
            ...
            park = upsert_park(
                ...
                defaults={
                    ...
                    "metadata_json": {
                        "source": "bc_parks_resource_location",
            ...
            upsert_campground(
                ...
                defaults={
                    ...
                    "description": None,
                    "amenities": {"source": "bc_parks", "root_map_id": row.get("rootMapId")},
        ...
        mark_directory_sync_completed(
            session,
            provider_id=provider.id,
            source="bc_parks_directory_sync",
